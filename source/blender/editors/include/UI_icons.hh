...
/* HYPERNOVA */
DEF_ICON(HYPERNOVA_DYNAMIC_MODEL_DATABASE)
DEF_ICON(HYPERNOVA_MODEL_SEGMENTATION) 
DEF_ICON(HYPERNOVA_PIVOT_POINT)
DEF_ICON(HYPERNOVA_ADDITIONAL_DATA)
DEF_ICON(HYPERNOVA_PRIMITIVE_COLLIDER)
DEF_ICON(HYPERNOVA_TEXTURE_PAINTING)
DEF_ICON(HYPERNOVA_EXPORTER)
DEF_ICON(HYPERNOVA_UTILITIES)
