...
const bTheme U_theme_default = {
  ...
  .space_properties = {
    ...
    .title = RGBA(0x30303000),
    .text = RGBA(0x30303000),
    .text_hi = RGBA(0x30303000),
    .header = RGBA(0x30303000),
    .header_text = RGBA(0x30303000),
    .header_text_hi = RGBA(0x30303000),
    .tab_active = RGBA(0x30303000),
    .tab_inactive = RGBA(0x30303000),
    .tab_back = RGBA(0x30303000),
    .tab_outline = RGBA(0x30303000),
    .button = RGBA(0x30303000),
    .button_title = RGBA(0x30303000),
    .button_text = RGBA(0x30303000),
    .button_text_hi = RGBA(0x30303000),
    .navigation_bar = RGBA(0x30303000),
    .execution_buts = RGBA(0x30303000),
    .panelcolors = {
      .header = RGBA(0x30303000),
      .back = RGBA(0x30303000),
      .sub_back = RGBA(0x30303000),
    },
    .active = RGBA(0x30303000),
    .vertex_size = 3,
    .outline_width = 1,
    .facedot_size = 4,
    .match = RGBA(0x30303000),
  },
  .space_hypernova = {
    .back = RGBA(0x30303000),
